...
== Hardware: Intel Gaudi 3

The AI inference powering this lab runs on Intel Gaudi 3 accelerators — Intel's purpose-built AI hardware platform. The multi-agent system uses qwen3-14b served by vLLM optimized for Intel Gaudi, delivering sub-second tool calling at scale across all five agent personas.
