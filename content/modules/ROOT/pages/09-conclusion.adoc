...
. **Automated quality gates**: Observability tells you if systems work; automated evaluations tell you if they work *well*.
...
|Baseline metrics from automated evaluations
|===
